...
<template>
  <div class="edit-telecom-login">
    ...
    <ui-card class="mb-4">
      ...
      <!-- 登录方式选择 -->
      <ui-select
        :model-value="data.loginType"
        label="登录方式"
        class="mb-2"
        @change="updateData({ loginType: $event })"
      >
      ...
      <!-- 账号密码登录 -->
      <form v-if="data.loginType === 'password'" @submit.prevent>
        <ui-input
